...
<h5>Who We Work With <a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right"><i class="fa fa-plus"></i> Add New</a></h5>
</div>
<div class="card-body">
...
<div class="modal-title"><h4>Who we work with</h4></div>
...
<div class="form-group col-sm-6">
<label for="img">Select Logo[120X82]:</label>
...
<div class="form-group col-sm-6">
<label for="upimg">Select Logo[120X82]:</label>
