...
<label for="roomimg">Room Image:[600X500]</label>
<input type="file" class="form-control" id="roomimg" name="timage">
</div>
<div class="form-group col-sm-4">
<label for="coverimg">Cover Image:[1920X500]</label>
...
<textarea class="form-control ckeditor" id="fulldesc" name="fulldesc" rows="3"><?php echo $data->roomcat_fulldesc; ?></textarea>
</div>
