...
<html lang="en">
<head>
<title>Parent-Location/City</title>
...
<h5>Parent-Location/City<a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right"><i class="fa fa-plus"></i> Add New</a></h5>
</div>
<div class="card-body">
...
<div class="modal-title"><h4>Add New Parent-Location/City</h4></div>
...
<div class="form-group col-sm-12">
<label for="img">Select Image[620X410]:</label>
...
<div class="modal-content">
<div class="modal-header">
<div class="modal-title"><h4>Update Parent-Location/City</h4></div>
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
</div>
<div class="modal-body">
...
<div class="form-group col-sm-12">
<label for="upimg">Select Image[620X410]:</label>
...
e.preventDefault();
if($("#addfrm").valid()){
    var url="helper/master/parent_location";
...
function fetchData(){
  $.ajax({
    type: "POST",
    url: "helper/master/parent_location",
