...
<h5>Location<a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right"><i class="fa fa-plus"></i> Add New</a></h5>
</div>
<div class="card-body">
...
<label for="category">Select City:<span class="req">*</span></label>
...
<div class="form-group col-sm-12">
<label for="roomnum">Enter Location:</label>
...
<div class="form-group col-sm-12">
<label for="uproom">Select City:<span class="req">*</span></label>
...
<div class="form-group col-sm-12">
<label for="uproomno">Enter Location:</label>
<input type="text" class="form-control" id="uproomno" name="uproomno" required="">
</div>
