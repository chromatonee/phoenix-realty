...
elseif ($operation=="fetchGal"){
	...
	<td><?php echo $i++; ?></td>
	<td><img height="30" src="../files/property-gallery/<?php echo $pg_img_lg;  ?>"></td>
	<td><img height="30" src="../files/property-gallery/<?php echo $pg_img_md;  ?>"></td>
...
elseif ($operation=="upGal"){
	...
	if(!empty($_FILES['image']['name'])){
		...
		if (!empty($data->pg_img_lg) AND file_exists("../../../files/property-gallery/".$data->pg_img_lg)){
			@unlink("../../../files/property-gallery/".$data->pg_img_lg);
		}
		if (!empty($data->pg_img_md) AND file_exists("../../../files/property-gallery/".$data->pg_img_md)){
			@unlink("../../../files/property-gallery/".$data->pg_img_md);
		}
	}
...
elseif ($operation=="activethumb" OR $operation=="deactivethumb" OR $operation=="deletethumb") {
	...
	$ad  = ($operation=='deletethumb')?", pg_delete_at=NOW()":null;
