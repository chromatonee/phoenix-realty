...
if ($operation=="fetch"){
	...
	if((!empty($testi_img)) AND file_exists("../../../files/testimonials/".$testi_img)) {
		echo '<img src="../files/testimonials/'.$testi_img.'" height="20">';
	}else{
		echo '<img src="../files/testimonials/user.png" height="20">';
	}
	?>		
	</td>
...
elseif($operation=="update") {
	...
	if(!empty($_FILES['image']['name'])){
		...
		$img_file  = resize($width,$height,$dir,$img_thumb);
		if ((!empty($chk_id->testi_img)) AND file_exists("../../../files/testimonials/".$chk_id->testi_img)) {
			@unlink("../../../files/testimonials/".$chk_id->testi_img);
		}
	}
