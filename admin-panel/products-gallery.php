...
<li class="nav-item"><a class="nav-link active" href="products-gallery?id=<?= $data->pro_id; ?>">Property Gallery</a></li>
</ul>
<div class="row">
<div class="col-xl-12">
<div class="card card-statistics h-100">
<div class="card-title"><h5><?= $data->pro_name; ?> Gallery<a href="" data-toggle="modal" data-target="#addThumb" class="button x-small pull-right"><i class="fa fa-plus"></i> ADD PROPERTY IMAGE</a></h5></div>
<div class="card-body">
...
<div class="modal-title"><h4>Add Property Image</h4></div>
...
<label for="thumbimg">Select Image: [1280X850][JPG/JPEG]</label>
<input type="file" class="form-control" id="thumbimg" name="image" required="">
</div>
<div class="form-group col-sm-12">
<label for="thumbimgname">Property Image Name:</label>
...
<div class="row">
<div class="form-group col-sm-12">
<label for="upthumbimg">Select Image: [1280X850][JPG/JPEG]</label>
<input type="file" class="form-control" id="upthumbimg" name="image">
</div>
<div class="form-group col-sm-12">
<label for="upthumbimgname">Property Image Name:</label>
