...
<h5>Our Team<a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right"><i class="fa fa-plus"></i> Add New</a></h5>
</div>
<div class="card-body">
...
<div class="modal-title"><h4>Add New Member</h4></div>
...
<div class="form-group col-sm-6">
<label for="img">Select Member Image:[120X120]</label>
<input type="file" class="form-control" id="img" name="image">
</div>
<div class="form-group col-sm-12">
<label for="msg">Designation:</label>
<input type="text" class="form-control" rows="2" id="msg" name="msg" required="" autofocus="">
</div>
...
<div class="modal-content">
<div class="modal-header">
<div class="modal-title"><h4>Update Member</h4></div>
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
</div>
<div class="modal-body">
...
<div class="row">
<div class="form-group col-sm-6">
<label for="upname">Enter Member Name:</label>
<input type="text" class="form-control" id="upname" name="upname" required="" autofocus="">
</div>
<div class="form-group col-sm-6">
<label for="upimg">Select Member Image:[120X120]</label>
<input type="file" class="form-control" id="upimg" name="image">
</div>
<div class="form-group col-sm-12">
<label for="upmsg">Designation:</label>
<input type="text" class="form-control" rows="2" id="upmsg" name="upmsg" required="">
</div>
<div class="form-group col-12">
